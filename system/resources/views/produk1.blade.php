...
<section class="ftco-section">
  ...
  <h4 class="text-center font-weight-bold col-md-12">PRODUK TERBARU</h4>
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-mt-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{url('produk1')}}" method="post">
                            @csrf
            ...
            <div class="row">
              ...
              <div class="card" style="width: 16rem;">
                <img src="public/assets/images/cabai.png" class="card-img-top" alt="...">
                <div class="card-body">
                  <h5 class="card-title">Cabai</h5>
                  <p class="card-text">Sebagai bumbu, cabai bahkan dianggap sebagai "bahan makanan pokok" ke sepuluh (alih-alih sembilan). Sangat sulit bagi masakan Padang dibuat tanpa cabai.</p>
              ...
              <div class="col-md-6">
              <div class="card" style="width: 16rem;">
                <img src="public/assets/images/sereh.png" class="card-img-top" alt="...">
                <div class="card-body">
                  <h5 class="card-title">Serai</h5>
                  <p class="card-text">Syang dimanfaatkan sebagai bumbu dapur </p>
